...
const Box9 = ({ tumanlar, chooseTumanHandler }) => {
            ...
            <svg viewBox="0 0 800 600" className="svg-map" xmlns="http://www.w3.org/2000/svg" >
                ...
                <g id="Слой_3" data-name="Слой 3">
                    <g id="Наманганская_область" data-name="Наманганская область">
                        ...
                        <motion.path onMouseEnter={() => showLabelHandler("Chust tumani")} onMouseLeave={hideLabelHandler} id="2" onClick={chooseTumanHandler} data-id="2" className="cls-5"
                        ...
                        ></motion.path>
                        <motion.path onMouseEnter={() => showLabelHandler("Uychi tumani")} onMouseLeave={hideLabelHandler} id="8" onClick={chooseTumanHandler} data-id="10" className="cls-5"
                            d="M714.21,284.56s-6.38,6.77-8.38,10.77-9.66,10.84-9.66,10.84c3.33,6.83-9.5,21.33-12,23.33S673,337,669.67,339.83s-1.5,6-2.5,8.5-7.67,6.34-9.84,8.34-1.16,7-6,9.33c0,0,.06,1.92.2,4.52l-7-1.69-8.67,8.67H631s-4.33,6.5-4.83,6.83-3.84,1.84-3.84,1.84l-1.16,5.5H614a7.29,7.29,0,0,1-3.83,3.71c-3,1.37-9.5.95-9.5.95l-7.34,9.84h-5.66l-.67-4.5a23,23,0,0,1-8.3-3.34c-4-2.66-3.87-13-3.87-13l3.5-3.5s.84-3.66,0-6.16-7.66-1.17-8.66-3.84-.17-17,0-19.66-3.39-11.14-3.5-11.4l47.16.9c7.84-5.34,11.17-13.5,12.84-17.34S633.67,318,637,317s6.83.83,6.83.83a46,46,0,0,0,0-5c-.16-1.66-4.83-.16-5.66-9.83s7.16-16.5,7.16-21.33S639,268,639,268s10.67,3.83,12.33,5.33,4.17-.5,6.34-.16,3.16,1.83,4.66,2.33,10.34-7.5,10.84-7.5S693,272.83,693,272.83,709.54,282.78,714.21,284.56Z"
                            data-name="Уйчинский район"
                            initial={{
                                pathLength: 0,
                            }}
                            whileHover={{
                        ...
                        ></motion.path>
                        <motion.path onMouseEnter={() => showLabelHandler("Norin tumani")} onMouseLeave={hideLabelHandler} id="10" onClick={chooseTumanHandler} data-id="6" className="cls-5"
                            d="M734.67,397.33c-1.67,3.17-1.17,8-1.17,8l-11,.34-.33,8.66,3.33,5.84-5,2.5-3.33,6.66-9.34-1.16v-5.34s-8-.33-10.33-.33-3,2-4.33,2.67-5.34-.5-5.34-.5c-.66-4.34-3.16-3.84-6.66-4.67a7.73,7.73,0,0,0-6,1L671,418l-12.5.17-4.33-8-5.34.16s-6.66-3.66-8.16-4.5-3,.17-5.5.17-3.17-1-6.67-2.5-7.83,1.83-7.83,1.83l-11.84.34-6.33,5.16H598l-4.5,2-2.83,4.84s-4.5-3-5-3c-.28,0-5.49,1.31-10,2.46.31-.08,1.34-7.3,3.67-8.8s8.34-2.16,8.34-2.16h5.66l7.34-9.84s6.5.42,9.5-.95a7.29,7.29,0,0,0,3.83-3.71h7.17l1.16-5.5s3.34-1.5,3.84-1.84S631,377.5,631,377.5h4.83l8.67-8.67,7,1.69c.23,4.81.71,12,1.47,13.81,1.17,2.84,8,2.17,8,2.17s4.17-9,5.5-11.33-1-9,5.5-11.67c3.67-1.83,7.33,8.83,12,7.67,2.17-.34,2.33-10.5,4.17-11.34s5.66,4.34,5.66,4.34,4-1.67,6.5-1.17,2.17,8.83,2.17,8.83L699,382l2.17,7.67,3.5-.34C709.33,381,711,366.5,711,366.5l5.33-1.33,2.84,3.16,7.83-2,9,29.05A10.13,10.13,0,0,0,734.67,397.33Z"
                            data-name="Нарынский район"
                            initial={{
                                pathLength: 0,
                            }}
                            whileHover={{
